  ...
  return (
    <footer className="flex flex-col m-auto p-4 max-w-fit items-center justify-center">
      ...
      <ul className="text-white text-[8px] md:text-[18px] flex flex-row justify-evenly w-full max-w-5xl">
        ...
        <li className="after:content-['|'] after:text-gray-600 after:mx-2"><a href="https://github.com/DarkShadowySuperCoders" target="_blank" rel="noreferrer" aria-label="GitHub (Opens in new Window)" className="text-purple-400 hover:text-purple-600 focus:text-purple-600 focus:outline-none">GitHub</a></li>
