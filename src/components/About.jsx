...
const About = () => {
  return (
    <div className='flex flex-col items-center justify-center w-screen h-screen text-white cursor-cell' id='about'>
      ...
      <div className='max-w-[376px] lg:max-w-5xl pt-4 text-white justify-center text-justify text-[18px] items-center'>
